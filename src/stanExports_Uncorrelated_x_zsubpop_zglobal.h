...
namespace model_Uncorrelated_x_zsubpop_zglobal_namespace {
using stan::model::model_base_crtp;
using namespace stan::math;
stan::math::profile_map profiles__;
static constexpr std::array<const char*, 64> locations_array__ =
  {" (found before start of program)",
  " (in 'Uncorrelated_x_zsubpop_zglobal', line 12, column 2 to column 20)",
  " (in 'Uncorrelated_x_zsubpop_zglobal', line 13, column 2 to column 28)",
  " (in 'Uncorrelated_x_zsubpop_zglobal', line 14, column 2 to column 22)",
  " (in 'Uncorrelated_x_zsubpop_zglobal', line 15, column 2 to column 20)",
  " (in 'Uncorrelated_x_zsubpop_zglobal', line 16, column 2 to column 36)",
  " (in 'Uncorrelated_x_zsubpop_zglobal', line 17, column 2 to column 41)",
  " (in 'Uncorrelated_x_zsubpop_zglobal', line 18, column 2 to column 29)",
  " (in 'Uncorrelated_x_zsubpop_zglobal', line 19, column 2 to column 18)",
  " (in 'Uncorrelated_x_zsubpop_zglobal', line 20, column 2 to column 14)",
  " (in 'Uncorrelated_x_zsubpop_zglobal', line 21, column 2 to column 26)",
  " (in 'Uncorrelated_x_zsubpop_zglobal', line 24, column 2 to column 17)",
  " (in 'Uncorrelated_x_zsubpop_zglobal', line 25, column 2 to column 18)",
  " (in 'Uncorrelated_x_zsubpop_zglobal', line 26, column 2 to column 23)",
  " (in 'Uncorrelated_x_zsubpop_zglobal', line 27, column 2 to column 177)",
  " (in 'Uncorrelated_x_zsubpop_zglobal', line 28, column 2 to column 45)",
  " (in 'Uncorrelated_x_zsubpop_zglobal', line 29, column 2 to column 39)",
  " (in 'Uncorrelated_x_zsubpop_zglobal', line 31, column 1 to column 42)",
  " (in 'Uncorrelated_x_zsubpop_zglobal', line 30, column 17 to line 32, column 3)",
  " (in 'Uncorrelated_x_zsubpop_zglobal', line 30, column 2 to line 32, column 3)",
  " (in 'Uncorrelated_x_zsubpop_zglobal', line 35, column 2 to column 23)",
  " (in 'Uncorrelated_x_zsubpop_zglobal', line 36, column 2 to column 31)",
  " (in 'Uncorrelated_x_zsubpop_zglobal', line 37, column 2 to column 25)",
  " (in 'Uncorrelated_x_zsubpop_zglobal', line 38, column 2 to column 32)",
  " (in 'Uncorrelated_x_zsubpop_zglobal', line 39, column 2 to column 24)",
  " (in 'Uncorrelated_x_zsubpop_zglobal', line 40, column 2 to column 41)",
  " (in 'Uncorrelated_x_zsubpop_zglobal', line 41, column 2 to column 30)",
  " (in 'Uncorrelated_x_zsubpop_zglobal', line 42, column 2 to column 29)",
  " (in 'Uncorrelated_x_zsubpop_zglobal', line 43, column 2 to column 25)",
  " (in 'Uncorrelated_x_zsubpop_zglobal', line 44, column 2 to column 34)",
  " (in 'Uncorrelated_x_zsubpop_zglobal', line 46, column 4 to column 47)",
  " (in 'Uncorrelated_x_zsubpop_zglobal', line 45, column 17 to line 47, column 3)",
  " (in 'Uncorrelated_x_zsubpop_zglobal', line 45, column 2 to line 47, column 3)",
  " (in 'Uncorrelated_x_zsubpop_zglobal', line 2, column 2 to column 19)",
  " (in 'Uncorrelated_x_zsubpop_zglobal', line 3, column 2 to column 19)",
  " (in 'Uncorrelated_x_zsubpop_zglobal', line 4, column 2 to column 29)",
  " (in 'Uncorrelated_x_zsubpop_zglobal', line 5, column 2 to column 29)",
  " (in 'Uncorrelated_x_zsubpop_zglobal', line 6, column 9 to column 12)",
  " (in 'Uncorrelated_x_zsubpop_zglobal', line 6, column 14 to column 17)",
  " (in 'Uncorrelated_x_zsubpop_zglobal', line 6, column 2 to column 21)",
  " (in 'Uncorrelated_x_zsubpop_zglobal', line 7, column 9 to column 12)",
  " (in 'Uncorrelated_x_zsubpop_zglobal', line 7, column 14 to column 27)",
  " (in 'Uncorrelated_x_zsubpop_zglobal', line 7, column 2 to column 38)",
  " (in 'Uncorrelated_x_zsubpop_zglobal', line 8, column 9 to column 12)",
  " (in 'Uncorrelated_x_zsubpop_zglobal', line 8, column 14 to column 27)",
  " (in 'Uncorrelated_x_zsubpop_zglobal', line 8, column 2 to column 38)",
  " (in 'Uncorrelated_x_zsubpop_zglobal', line 9, column 8 to column 11)",
  " (in 'Uncorrelated_x_zsubpop_zglobal', line 9, column 12 to column 15)",
  " (in 'Uncorrelated_x_zsubpop_zglobal', line 9, column 2 to column 23)",
  " (in 'Uncorrelated_x_zsubpop_zglobal', line 12, column 9 to column 12)",
  " (in 'Uncorrelated_x_zsubpop_zglobal', line 14, column 9 to column 12)",
  " (in 'Uncorrelated_x_zsubpop_zglobal', line 14, column 13 to column 16)",
  " (in 'Uncorrelated_x_zsubpop_zglobal', line 15, column 9 to column 12)",
  " (in 'Uncorrelated_x_zsubpop_zglobal', line 16, column 9 to column 22)",
  " (in 'Uncorrelated_x_zsubpop_zglobal', line 17, column 9 to column 22)",
  " (in 'Uncorrelated_x_zsubpop_zglobal', line 17, column 24 to column 27)",
  " (in 'Uncorrelated_x_zsubpop_zglobal', line 18, column 18 to column 21)",
  " (in 'Uncorrelated_x_zsubpop_zglobal', line 19, column 9 to column 12)",
  " (in 'Uncorrelated_x_zsubpop_zglobal', line 24, column 9 to column 12)",
  " (in 'Uncorrelated_x_zsubpop_zglobal', line 25, column 9 to column 12)",
  " (in 'Uncorrelated_x_zsubpop_zglobal', line 26, column 9 to column 12)",
  " (in 'Uncorrelated_x_zsubpop_zglobal', line 26, column 13 to column 16)",
  " (in 'Uncorrelated_x_zsubpop_zglobal', line 27, column 9 to column 12)",
  " (in 'Uncorrelated_x_zsubpop_zglobal', line 27, column 13 to column 16)"};
#include <stan_meta_header.hpp>
class model_Uncorrelated_x_zsubpop_zglobal final : public model_base_crtp<model_Uncorrelated_x_zsubpop_zglobal> {
private:
  int n_i;
  int n_k;
  int z_global_size;
...
public:
  ~model_Uncorrelated_x_zsubpop_zglobal() {}
  model_Uncorrelated_x_zsubpop_zglobal(stan::io::var_context& context__,
    ...
    static constexpr const char* function__ =
      "model_Uncorrelated_x_zsubpop_zglobal_namespace::model_Uncorrelated_x_zsubpop_zglobal";
    // suppress unused var warning
    (void) function__;
  ...
  inline std::string model_name() const final {
    return "model_Uncorrelated_x_zsubpop_zglobal";
  }
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    (void) DUMMY_VAR__;
    static constexpr const char* function__ =
      "model_Uncorrelated_x_zsubpop_zglobal_namespace::log_prob";
    // suppress unused var warning
    (void) function__;
    try {
  ...
  write_array_impl(RNG& base_rng__, VecR& params_r__, VecI& params_i__,
    ...
    static constexpr const char* function__ =
      "model_Uncorrelated_x_zsubpop_zglobal_namespace::write_array";
    // suppress unused var warning
    (void) function__;
    try {
  ...
  get_param_names(std::vector<std::string>& names__, const bool
    ...
    names__ = std::vector<std::string>{"delta", "sigma_delta", "eps",
                "alpha", "beta_global", "beta_subpop", "tau_N", "rho",
                "mu_rho", "sigma_rho"};
    if (emit_transformed_parameters__) {
  ...
  inline std::string get_constrained_sizedtypes() const {
    return std::string("[{\"name\":\"delta\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(n_i) + "},\"block\":\"parameters\"},{\"name\":\"sigma_delta\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"eps\",\"type\":{\"name\":\"matrix\",\"rows\":" + std::to_string(n_i) + ",\"cols\":" + std::to_string(n_k) + "},\"block\":\"parameters\"},{\"name\":\"alpha\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(n_k) + "},\"block\":\"parameters\"},{\"name\":\"beta_global\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(z_global_size) + "},\"block\":\"parameters\"},{\"name\":\"beta_subpop\",\"type\":{\"name\":\"matrix\",\"rows\":" + std::to_string(z_subpop_size) + ",\"cols\":" + std::to_string(n_k) + "},\"block\":\"parameters\"},{\"name\":\"tau_N\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(n_k) + "},\"block\":\"parameters\"},{\"name\":\"rho\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(n_k) + "},\"block\":\"parameters\"},{\"name\":\"mu_rho\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"sigma_rho\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"mu\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(n_k) + "},\"block\":\"transformed_parameters\"},{\"name\":\"tau\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(n_k) + "},\"block\":\"transformed_parameters\"},{\"name\":\"bias\",\"type\":{\"name\":\"matrix\",\"rows\":" + std::to_string(n_i) + ",\"cols\":" + std::to_string(n_k) + "},\"block\":\"transformed_parameters\"},{\"name\":\"prev_mean\",\"type\":{\"name\":\"matrix\",\"rows\":" + std::to_string(n_i) + ",\"cols\":" + std::to_string(n_k) + "},\"block\":\"transformed_parameters\"}]");
  }
  ...
  write_array(RNG& base_rng, Eigen::Matrix<double,-1,1>& params_r,
    ...
    const size_t num_params__ = (((((((((n_i + 1) + (n_i * n_k)) + n_k) +
      z_global_size) + (z_subpop_size * n_k)) + n_k) + n_k) + 1) + 1);
...
using stan_model = model_Uncorrelated_x_zsubpop_zglobal_namespace::model_Uncorrelated_x_zsubpop_zglobal;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_Uncorrelated_x_zsubpop_zglobal_namespace::profiles__;
}
#endif
#endif
