...
namespace model_Teo_basic_model_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_Teo_basic_model");
    reader.add_event(32, 30, "end", "model_Teo_basic_model");
    return reader;
}
#include <stan_meta_header.hpp>
class model_Teo_basic_model
  : public stan::model::model_base_crtp<model_Teo_basic_model> {
private:
        int N;
        int n_i;
        int n_k;
...
public:
    model_Teo_basic_model(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_Teo_basic_model_namespace::model_Teo_basic_model";
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            for (int k = 1; k <= n_unknown; ++k) {
                ...
                lp_accum__.add(poisson_log<propto__>(stan::model::rvalue(y, stan::model::cons_list(stan::model::index_omni(), stan::model::cons_list(stan::model::index_uni((n_known + k)), stan::model::nil_index_list())), "y"), multiply(multiply(lambda, alpha), get_base1(S_H, k, "S_H", 1))));
            }
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
            // Next line prevents compiler griping about no return
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_Teo_basic_model_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_Teo_basic_model_namespace::model_Teo_basic_model stan_model;
#ifndef USING_R
