...
namespace model_Correlated_basic_namespace {
using stan::model::model_base_crtp;
using namespace stan::math;
stan::math::profile_map profiles__;
static constexpr std::array<const char*, 47> locations_array__ =
  {" (found before start of program)",
  " (in 'Correlated_basic', line 7, column 2 to column 20)",
  " (in 'Correlated_basic', line 8, column 2 to column 28)",
  " (in 'Correlated_basic', line 9, column 2 to column 22)",
  " (in 'Correlated_basic', line 10, column 2 to column 29)",
  " (in 'Correlated_basic', line 11, column 2 to column 36)",
  " (in 'Correlated_basic', line 12, column 2 to column 18)",
  " (in 'Correlated_basic', line 13, column 2 to column 14)",
  " (in 'Correlated_basic', line 14, column 2 to column 26)",
  " (in 'Correlated_basic', line 17, column 2 to column 17)",
  " (in 'Correlated_basic', line 18, column 2 to column 18)",
  " (in 'Correlated_basic', line 19, column 2 to column 23)",
  " (in 'Correlated_basic', line 20, column 2 to column 28)",
  " (in 'Correlated_basic', line 38, column 2 to column 24)",
  " (in 'Correlated_basic', line 21, column 2 to column 80)",
  " (in 'Correlated_basic', line 22, column 2 to column 45)",
  " (in 'Correlated_basic', line 23, column 2 to column 39)",
  " (in 'Correlated_basic', line 24, column 2 to column 79)",
  " (in 'Correlated_basic', line 39, column 2 to column 28)",
  " (in 'Correlated_basic', line 27, column 2 to column 23)",
  " (in 'Correlated_basic', line 28, column 2 to column 31)",
  " (in 'Correlated_basic', line 29, column 2 to column 25)",
  " (in 'Correlated_basic', line 30, column 2 to column 32)",
  " (in 'Correlated_basic', line 31, column 2 to column 33)",
  " (in 'Correlated_basic', line 32, column 2 to column 34)",
  " (in 'Correlated_basic', line 34, column 4 to column 47)",
  " (in 'Correlated_basic', line 33, column 17 to line 35, column 3)",
  " (in 'Correlated_basic', line 33, column 2 to line 35, column 3)",
  " (in 'Correlated_basic', line 2, column 2 to column 19)",
  " (in 'Correlated_basic', line 3, column 2 to column 19)",
  " (in 'Correlated_basic', line 4, column 8 to column 11)",
  " (in 'Correlated_basic', line 4, column 12 to column 15)",
  " (in 'Correlated_basic', line 4, column 2 to column 23)",
  " (in 'Correlated_basic', line 7, column 9 to column 12)",
  " (in 'Correlated_basic', line 9, column 9 to column 12)",
  " (in 'Correlated_basic', line 9, column 13 to column 16)",
  " (in 'Correlated_basic', line 10, column 18 to column 21)",
  " (in 'Correlated_basic', line 11, column 23 to column 26)",
  " (in 'Correlated_basic', line 12, column 9 to column 12)",
  " (in 'Correlated_basic', line 17, column 9 to column 12)",
  " (in 'Correlated_basic', line 18, column 9 to column 12)",
  " (in 'Correlated_basic', line 19, column 9 to column 12)",
  " (in 'Correlated_basic', line 19, column 13 to column 16)",
  " (in 'Correlated_basic', line 20, column 9 to column 12)",
  " (in 'Correlated_basic', line 20, column 13 to column 16)",
  " (in 'Correlated_basic', line 38, column 9 to column 12)",
  " (in 'Correlated_basic', line 38, column 14 to column 17)"};
#include <stan_meta_header.hpp>
class model_Correlated_basic final : public model_base_crtp<model_Correlated_basic> {
private:
  int n_i;
  int n_k;
  std::vector<std::vector<int>> y;
public:
  ~model_Correlated_basic() {}
  model_Correlated_basic(stan::io::var_context& context__, unsigned int
    ...
    static constexpr const char* function__ =
      "model_Correlated_basic_namespace::model_Correlated_basic";
    // suppress unused var warning
    (void) function__;
    ...
    num_params_r__ = n_i + 1 + (n_i * n_k) + n_k + ((n_k * (n_k - 1)) / 2) +
      n_k + 1 + 1;
  }
  inline std::string model_name() const final {
    return "model_Correlated_basic";
  }
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    (void) DUMMY_VAR__;
    static constexpr const char* function__ =
      "model_Correlated_basic_namespace::log_prob";
    // suppress unused var warning
    (void) function__;
    try {
  ...
  write_array_impl(RNG& base_rng__, VecR& params_r__, VecI& params_i__,
    ...
    static constexpr const char* function__ =
      "model_Correlated_basic_namespace::write_array";
    // suppress unused var warning
    (void) function__;
    try {
  ...
  get_param_names(std::vector<std::string>& names__, const bool
    ...
    names__ = std::vector<std::string>{"delta", "sigma_delta", "eps",
                "tau_N", "L_Omega", "rho", "mu_rho", "sigma_rho"};
    if (emit_transformed_parameters__) {
  ...
  inline std::string get_constrained_sizedtypes() const {
    return std::string("[{\"name\":\"delta\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(n_i) + "},\"block\":\"parameters\"},{\"name\":\"sigma_delta\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"eps\",\"type\":{\"name\":\"matrix\",\"rows\":" + std::to_string(n_i) + ",\"cols\":" + std::to_string(n_k) + "},\"block\":\"parameters\"},{\"name\":\"tau_N\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(n_k) + "},\"block\":\"parameters\"},{\"name\":\"L_Omega\",\"type\":{\"name\":\"matrix\",\"rows\":" + std::to_string(n_k) + ",\"cols\":" + std::to_string(n_k) + "},\"block\":\"parameters\"},{\"name\":\"rho\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(n_k) + "},\"block\":\"parameters\"},{\"name\":\"mu_rho\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"sigma_rho\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"mu\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(n_k) + "},\"block\":\"transformed_parameters\"},{\"name\":\"tau\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(n_k) + "},\"block\":\"transformed_parameters\"},{\"name\":\"bias\",\"type\":{\"name\":\"matrix\",\"rows\":" + std::to_string(n_i) + ",\"cols\":" + std::to_string(n_k) + "},\"block\":\"transformed_parameters\"},{\"name\":\"prev_mean\",\"type\":{\"name\":\"matrix\",\"rows\":" + std::to_string(n_i) + ",\"cols\":" + std::to_string(n_k) + "},\"block\":\"transformed_parameters\"},{\"name\":\"Corr\",\"type\":{\"name\":\"matrix\",\"rows\":" + std::to_string(n_k) + ",\"cols\":" + std::to_string(n_k) + "},\"block\":\"generated_quantities\"}]");
  }
  inline std::string get_unconstrained_sizedtypes() const {
    return std::string("[{\"name\":\"delta\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(n_i) + "},\"block\":\"parameters\"},{\"name\":\"sigma_delta\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"eps\",\"type\":{\"name\":\"matrix\",\"rows\":" + std::to_string(n_i) + ",\"cols\":" + std::to_string(n_k) + "},\"block\":\"parameters\"},{\"name\":\"tau_N\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(n_k) + "},\"block\":\"parameters\"},{\"name\":\"L_Omega\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(((n_k * (n_k - 1)) /2)) + "},\"block\":\"parameters\"},{\"name\":\"rho\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(n_k) + "},\"block\":\"parameters\"},{\"name\":\"mu_rho\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"sigma_rho\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"mu\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(n_k) + "},\"block\":\"transformed_parameters\"},{\"name\":\"tau\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(n_k) + "},\"block\":\"transformed_parameters\"},{\"name\":\"bias\",\"type\":{\"name\":\"matrix\",\"rows\":" + std::to_string(n_i) + ",\"cols\":" + std::to_string(n_k) + "},\"block\":\"transformed_parameters\"},{\"name\":\"prev_mean\",\"type\":{\"name\":\"matrix\",\"rows\":" + std::to_string(n_i) + ",\"cols\":" + std::to_string(n_k) + "},\"block\":\"transformed_parameters\"},{\"name\":\"Corr\",\"type\":{\"name\":\"matrix\",\"rows\":" + std::to_string(n_k) + ",\"cols\":" + std::to_string(n_k) + "},\"block\":\"generated_quantities\"}]");
  }
...
using stan_model = model_Correlated_basic_namespace::model_Correlated_basic;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_Correlated_basic_namespace::profiles__;
}
#endif
#endif
