...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_Correlated_basic");
    reader.add_event(51, 49, "end", "model_Correlated_basic");
    return reader;
}
#include <stan_meta_header.hpp>
class model_Correlated_basic
  : public stan::model::model_base_crtp<model_Correlated_basic> {
private:
        int n_i;
        int n_k;
        std::vector<std::vector<int> > y;
public:
    model_Correlated_basic(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_Correlated_basic_namespace::model_Correlated_basic";
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            stan::math::assign(prev_mean, stan::math::exp(add(transpose(rep_matrix(rho, n_i)), rep_matrix(multiply(sigma_delta, delta), n_k))));
            ...
            lp_accum__.add(normal_log<propto__>(delta, 0, 1));
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_Correlated_basic_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_Correlated_basic_namespace::model_Correlated_basic stan_model;
#ifndef USING_R
