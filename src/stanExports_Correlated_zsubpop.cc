...
#include "stanExports_Correlated_zsubpop.h"

RCPP_MODULE(stan_fit4Correlated_zsubpop_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_Correlated_zsubpop")
