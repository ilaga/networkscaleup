...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_Correlated_x");
    reader.add_event(54, 52, "end", "model_Correlated_x");
    return reader;
}
#include <stan_meta_header.hpp>
class model_Correlated_x
  : public stan::model::model_base_crtp<model_Correlated_x> {
private:
        int n_i;
        int n_k;
        matrix_d x;
...
public:
    model_Correlated_x(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_Correlated_x_namespace::model_Correlated_x";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_Correlated_x_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_Correlated_x_namespace::model_Correlated_x stan_model;
#ifndef USING_R
