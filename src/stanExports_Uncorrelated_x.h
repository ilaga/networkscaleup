...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_Uncorrelated_x");
    reader.add_event(49, 47, "end", "model_Uncorrelated_x");
    return reader;
}
#include <stan_meta_header.hpp>
class model_Uncorrelated_x
  : public stan::model::model_base_crtp<model_Uncorrelated_x> {
private:
        int n_i;
        int n_k;
        matrix_d x;
...
public:
    model_Uncorrelated_x(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_Uncorrelated_x_namespace::model_Uncorrelated_x";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_Uncorrelated_x_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_Uncorrelated_x_namespace::model_Uncorrelated_x stan_model;
#ifndef USING_R
