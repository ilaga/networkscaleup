...
namespace model_Uncorrelated_x_namespace {
using stan::model::model_base_crtp;
using namespace stan::math;
stan::math::profile_map profiles__;
static constexpr std::array<const char*, 49> locations_array__ =
  {" (found before start of program)",
  " (in 'Uncorrelated_x', line 8, column 2 to column 20)",
  " (in 'Uncorrelated_x', line 9, column 2 to column 28)",
  " (in 'Uncorrelated_x', line 10, column 2 to column 22)",
  " (in 'Uncorrelated_x', line 11, column 2 to column 20)",
  " (in 'Uncorrelated_x', line 12, column 2 to column 29)",
  " (in 'Uncorrelated_x', line 13, column 2 to column 18)",
  " (in 'Uncorrelated_x', line 14, column 2 to column 14)",
  " (in 'Uncorrelated_x', line 15, column 2 to column 26)",
  " (in 'Uncorrelated_x', line 18, column 2 to column 17)",
  " (in 'Uncorrelated_x', line 19, column 2 to column 18)",
  " (in 'Uncorrelated_x', line 20, column 2 to column 23)",
  " (in 'Uncorrelated_x', line 21, column 2 to column 127)",
  " (in 'Uncorrelated_x', line 22, column 2 to column 45)",
  " (in 'Uncorrelated_x', line 23, column 2 to column 39)",
  " (in 'Uncorrelated_x', line 25, column 1 to column 42)",
  " (in 'Uncorrelated_x', line 24, column 17 to line 26, column 3)",
  " (in 'Uncorrelated_x', line 24, column 2 to line 26, column 3)",
  " (in 'Uncorrelated_x', line 29, column 2 to column 23)",
  " (in 'Uncorrelated_x', line 30, column 2 to column 31)",
  " (in 'Uncorrelated_x', line 31, column 2 to column 25)",
  " (in 'Uncorrelated_x', line 32, column 2 to column 32)",
  " (in 'Uncorrelated_x', line 33, column 2 to column 24)",
  " (in 'Uncorrelated_x', line 34, column 2 to column 29)",
  " (in 'Uncorrelated_x', line 35, column 2 to column 25)",
  " (in 'Uncorrelated_x', line 36, column 2 to column 34)",
  " (in 'Uncorrelated_x', line 38, column 4 to column 47)",
  " (in 'Uncorrelated_x', line 37, column 17 to line 39, column 3)",
  " (in 'Uncorrelated_x', line 37, column 2 to line 39, column 3)",
  " (in 'Uncorrelated_x', line 2, column 2 to column 19)",
  " (in 'Uncorrelated_x', line 3, column 2 to column 19)",
  " (in 'Uncorrelated_x', line 4, column 9 to column 12)",
  " (in 'Uncorrelated_x', line 4, column 14 to column 17)",
  " (in 'Uncorrelated_x', line 4, column 2 to column 21)",
  " (in 'Uncorrelated_x', line 5, column 8 to column 11)",
  " (in 'Uncorrelated_x', line 5, column 12 to column 15)",
  " (in 'Uncorrelated_x', line 5, column 2 to column 23)",
  " (in 'Uncorrelated_x', line 8, column 9 to column 12)",
  " (in 'Uncorrelated_x', line 10, column 9 to column 12)",
  " (in 'Uncorrelated_x', line 10, column 13 to column 16)",
  " (in 'Uncorrelated_x', line 11, column 9 to column 12)",
  " (in 'Uncorrelated_x', line 12, column 18 to column 21)",
  " (in 'Uncorrelated_x', line 13, column 9 to column 12)",
  " (in 'Uncorrelated_x', line 18, column 9 to column 12)",
  " (in 'Uncorrelated_x', line 19, column 9 to column 12)",
  " (in 'Uncorrelated_x', line 20, column 9 to column 12)",
  " (in 'Uncorrelated_x', line 20, column 13 to column 16)",
  " (in 'Uncorrelated_x', line 21, column 9 to column 12)",
  " (in 'Uncorrelated_x', line 21, column 13 to column 16)"};
#include <stan_meta_header.hpp>
class model_Uncorrelated_x final : public model_base_crtp<model_Uncorrelated_x> {
private:
  int n_i;
  int n_k;
...
public:
  ~model_Uncorrelated_x() {}
  model_Uncorrelated_x(stan::io::var_context& context__, unsigned int
    ...
    static constexpr const char* function__ =
      "model_Uncorrelated_x_namespace::model_Uncorrelated_x";
    // suppress unused var warning
    (void) function__;
    ...
    num_params_r__ = n_i + 1 + (n_i * n_k) + n_k + n_k + n_k + 1 + 1;
  }
  inline std::string model_name() const final {
    return "model_Uncorrelated_x";
  }
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    (void) DUMMY_VAR__;
    static constexpr const char* function__ =
      "model_Uncorrelated_x_namespace::log_prob";
    // suppress unused var warning
    (void) function__;
    try {
  ...
  write_array_impl(RNG& base_rng__, VecR& params_r__, VecI& params_i__,
    ...
    static constexpr const char* function__ =
      "model_Uncorrelated_x_namespace::write_array";
    // suppress unused var warning
    (void) function__;
    try {
  ...
  get_param_names(std::vector<std::string>& names__, const bool
    ...
    names__ = std::vector<std::string>{"delta", "sigma_delta", "eps",
                "alpha", "tau_N", "rho", "mu_rho", "sigma_rho"};
    if (emit_transformed_parameters__) {
  ...
  inline std::string get_constrained_sizedtypes() const {
    return std::string("[{\"name\":\"delta\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(n_i) + "},\"block\":\"parameters\"},{\"name\":\"sigma_delta\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"eps\",\"type\":{\"name\":\"matrix\",\"rows\":" + std::to_string(n_i) + ",\"cols\":" + std::to_string(n_k) + "},\"block\":\"parameters\"},{\"name\":\"alpha\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(n_k) + "},\"block\":\"parameters\"},{\"name\":\"tau_N\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(n_k) + "},\"block\":\"parameters\"},{\"name\":\"rho\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(n_k) + "},\"block\":\"parameters\"},{\"name\":\"mu_rho\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"sigma_rho\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"mu\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(n_k) + "},\"block\":\"transformed_parameters\"},{\"name\":\"tau\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(n_k) + "},\"block\":\"transformed_parameters\"},{\"name\":\"bias\",\"type\":{\"name\":\"matrix\",\"rows\":" + std::to_string(n_i) + ",\"cols\":" + std::to_string(n_k) + "},\"block\":\"transformed_parameters\"},{\"name\":\"prev_mean\",\"type\":{\"name\":\"matrix\",\"rows\":" + std::to_string(n_i) + ",\"cols\":" + std::to_string(n_k) + "},\"block\":\"transformed_parameters\"}]");
  }
...
using stan_model = model_Uncorrelated_x_namespace::model_Uncorrelated_x;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_Uncorrelated_x_namespace::profiles__;
}
#endif
#endif
