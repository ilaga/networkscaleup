...
#include "stanExports_Correlated_zglobal.h"

RCPP_MODULE(stan_fit4Correlated_zglobal_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_Correlated_zglobal")
