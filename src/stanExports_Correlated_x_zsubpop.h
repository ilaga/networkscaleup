...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_Correlated_x_zsubpop");
    reader.add_event(58, 56, "end", "model_Correlated_x_zsubpop");
    return reader;
}
#include <stan_meta_header.hpp>
class model_Correlated_x_zsubpop
  : public stan::model::model_base_crtp<model_Correlated_x_zsubpop> {
private:
        int n_i;
        int n_k;
        int z_subpop_size;
...
public:
    model_Correlated_x_zsubpop(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_Correlated_x_zsubpop_namespace::model_Correlated_x_zsubpop";
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            stan::math::assign(prev_mean,stan::math::exp(add(add(add(transpose(rep_matrix(rho, n_i)), elt_multiply(x, transpose(rep_matrix(alpha, n_i)))), multiply(z_subpop, beta_subpop)), rep_matrix(multiply(sigma_delta, delta), n_k))));
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_Correlated_x_zsubpop_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_Correlated_x_zsubpop_namespace::model_Correlated_x_zsubpop stan_model;
#ifndef USING_R
