...
namespace model_Teo_barrier_model_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_Teo_barrier_model");
    reader.add_event(45, 43, "end", "model_Teo_barrier_model");
    return reader;
}
#include <stan_meta_header.hpp>
class model_Teo_barrier_model
  : public stan::model::model_base_crtp<model_Teo_barrier_model> {
private:
        int N;
        int n_i;
        int n_k;
...
public:
    model_Teo_barrier_model(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_Teo_barrier_model_namespace::model_Teo_barrier_model";
        ...
        try {
            ...
            context__.validate_dims("data initialization", "z_size", "int", context__.to_vec());
            z_size = int(0);
            vals_i__ = context__.vals_i("z_size");
            pos__ = 0;
            z_size = vals_i__[pos__++];
            check_greater_or_equal(function__, "z_size", z_size, 0);
            ...
            validate_non_negative_index("z", "n_i", n_i);
            validate_non_negative_index("z", "z_size", z_size);
            context__.validate_dims("data initialization", "z", "matrix_d", context__.to_vec(n_i,z_size));
            z = Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic>(n_i, z_size);
            vals_r__ = context__.vals_r("z");
            pos__ = 0;
            size_t z_j_2_max__ = z_size;
            size_t z_j_1_max__ = n_i;
            ...
            validate_non_negative_index("gamma", "z_size", z_size);
            validate_non_negative_index("gamma", "n_k", n_k);
            num_params_r__ += (z_size * n_k);
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        validate_non_negative_index("gamma", "z_size", z_size);
        validate_non_negative_index("gamma", "n_k", n_k);
        context__.validate_dims("parameter initialization", "gamma", "matrix_d", context__.to_vec(z_size,n_k));
        Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic> gamma(z_size, n_k);
        size_t gamma_j_2_max__ = n_k;
        size_t gamma_j_1_max__ = z_size;
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            if (jacobian__)
                gamma = in__.matrix_constrain(z_size, n_k, lp__);
            else
                gamma = in__.matrix_constrain(z_size, n_k);
            current_statement_begin__ = 21;
            ...
            for (int k = 1; k <= n_k; ++k) {
                ...
                lp_accum__.add(normal_log<propto__>(stan::model::rvalue(gamma, stan::model::cons_list(stan::model::index_omni(), stan::model::cons_list(stan::model::index_uni(k), stan::model::nil_index_list())), "gamma"), 0, (1 / sigmag)));
            }
            current_statement_begin__ = 32;
            lp_accum__.add(gamma_log<propto__>(sigma, 1, 0.1));
            current_statement_begin__ = 33;
            lp_accum__.add(gamma_log<propto__>(sigmag, 1, 0.1));
            current_statement_begin__ = 35;
            for (int k = 1; k <= n_known; ++k) {
                current_statement_begin__ = 36;
                lp_accum__.add(poisson_log<propto__>(stan::model::rvalue(y, stan::model::cons_list(stan::model::index_omni(), stan::model::cons_list(stan::model::index_uni(k), stan::model::nil_index_list())), "y"), multiply(elt_multiply(multiply(lambda, alpha), stan::math::exp(multiply(z, stan::model::rvalue(gamma, stan::model::cons_list(stan::model::index_omni(), stan::model::cons_list(stan::model::index_uni(k), stan::model::nil_index_list())), "gamma")))), get_base1(S_K, k, "S_K", 1))));
            }
            current_statement_begin__ = 39;
            for (int k = 1; k <= n_unknown; ++k) {
                current_statement_begin__ = 40;
                lp_accum__.add(poisson_log<propto__>(stan::model::rvalue(y, stan::model::cons_list(stan::model::index_omni(), stan::model::cons_list(stan::model::index_uni((n_known + k)), stan::model::nil_index_list())), "y"), multiply(elt_multiply(elt_multiply(multiply(lambda, alpha), stan::math::exp(multiply(stan::model::rvalue(x, stan::model::cons_list(stan::model::index_omni(), stan::model::cons_list(stan::model::index_uni(k), stan::model::nil_index_list())), "x"), get_base1(beta, k, "beta", 1)))), stan::math::exp(multiply(z, stan::model::rvalue(gamma, stan::model::cons_list(stan::model::index_omni(), stan::model::cons_list(stan::model::index_uni((n_known + k)), stan::model::nil_index_list())), "gamma")))), get_base1(S_H, k, "S_H", 1))));
            }
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
            // Next line prevents compiler griping about no return
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_Teo_barrier_model_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        ...
        Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic> gamma = in__.matrix_constrain(z_size, n_k);
        size_t gamma_j_2_max__ = n_k;
        size_t gamma_j_1_max__ = z_size;
        for (size_t j_2__ = 0; j_2__ < gamma_j_2_max__; ++j_2__) {
            for (size_t j_1__ = 0; j_1__ < gamma_j_1_max__; ++j_1__) {
    ...
    std::string model_name() const {
        return "model_Teo_barrier_model";
    }
...
typedef model_Teo_barrier_model_namespace::model_Teo_barrier_model stan_model;
#ifndef USING_R
