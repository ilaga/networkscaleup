...
#include "stanExports_Correlated_basic.h"

RCPP_MODULE(stan_fit4Correlated_basic_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_Correlated_basic")
