...
namespace model_Uncorrelated_basic_namespace {
using stan::model::model_base_crtp;
using namespace stan::math;
stan::math::profile_map profiles__;
static constexpr std::array<const char*, 42> locations_array__ =
  {" (found before start of program)",
  " (in 'Uncorrelated_basic', line 7, column 2 to column 20)",
  " (in 'Uncorrelated_basic', line 8, column 2 to column 28)",
  " (in 'Uncorrelated_basic', line 9, column 2 to column 22)",
  " (in 'Uncorrelated_basic', line 10, column 2 to column 29)",
  " (in 'Uncorrelated_basic', line 11, column 2 to column 18)",
  " (in 'Uncorrelated_basic', line 12, column 2 to column 14)",
  " (in 'Uncorrelated_basic', line 13, column 2 to column 26)",
  " (in 'Uncorrelated_basic', line 16, column 2 to column 17)",
  " (in 'Uncorrelated_basic', line 17, column 2 to column 18)",
  " (in 'Uncorrelated_basic', line 18, column 2 to column 23)",
  " (in 'Uncorrelated_basic', line 19, column 2 to column 28)",
  " (in 'Uncorrelated_basic', line 20, column 2 to column 80)",
  " (in 'Uncorrelated_basic', line 21, column 2 to column 45)",
  " (in 'Uncorrelated_basic', line 22, column 2 to column 39)",
  " (in 'Uncorrelated_basic', line 24, column 1 to column 42)",
  " (in 'Uncorrelated_basic', line 23, column 17 to line 25, column 3)",
  " (in 'Uncorrelated_basic', line 23, column 2 to line 25, column 3)",
  " (in 'Uncorrelated_basic', line 28, column 2 to column 23)",
  " (in 'Uncorrelated_basic', line 29, column 2 to column 31)",
  " (in 'Uncorrelated_basic', line 30, column 2 to column 25)",
  " (in 'Uncorrelated_basic', line 31, column 2 to column 32)",
  " (in 'Uncorrelated_basic', line 32, column 2 to column 34)",
  " (in 'Uncorrelated_basic', line 34, column 4 to column 47)",
  " (in 'Uncorrelated_basic', line 33, column 17 to line 35, column 3)",
  " (in 'Uncorrelated_basic', line 33, column 2 to line 35, column 3)",
  " (in 'Uncorrelated_basic', line 2, column 2 to column 19)",
  " (in 'Uncorrelated_basic', line 3, column 2 to column 19)",
  " (in 'Uncorrelated_basic', line 4, column 8 to column 11)",
  " (in 'Uncorrelated_basic', line 4, column 12 to column 15)",
  " (in 'Uncorrelated_basic', line 4, column 2 to column 23)",
  " (in 'Uncorrelated_basic', line 7, column 9 to column 12)",
  " (in 'Uncorrelated_basic', line 9, column 9 to column 12)",
  " (in 'Uncorrelated_basic', line 9, column 13 to column 16)",
  " (in 'Uncorrelated_basic', line 10, column 18 to column 21)",
  " (in 'Uncorrelated_basic', line 11, column 9 to column 12)",
  " (in 'Uncorrelated_basic', line 16, column 9 to column 12)",
  " (in 'Uncorrelated_basic', line 17, column 9 to column 12)",
  " (in 'Uncorrelated_basic', line 18, column 9 to column 12)",
  " (in 'Uncorrelated_basic', line 18, column 13 to column 16)",
  " (in 'Uncorrelated_basic', line 19, column 9 to column 12)",
  " (in 'Uncorrelated_basic', line 19, column 13 to column 16)"};
#include <stan_meta_header.hpp>
class model_Uncorrelated_basic final : public model_base_crtp<model_Uncorrelated_basic> {
private:
  int n_i;
  int n_k;
  std::vector<std::vector<int>> y;
public:
  ~model_Uncorrelated_basic() {}
  model_Uncorrelated_basic(stan::io::var_context& context__, unsigned int
    ...
    static constexpr const char* function__ =
      "model_Uncorrelated_basic_namespace::model_Uncorrelated_basic";
    // suppress unused var warning
    (void) function__;
    ...
    num_params_r__ = n_i + 1 + (n_i * n_k) + n_k + n_k + 1 + 1;
  }
  inline std::string model_name() const final {
    return "model_Uncorrelated_basic";
  }
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    (void) DUMMY_VAR__;
    static constexpr const char* function__ =
      "model_Uncorrelated_basic_namespace::log_prob";
    // suppress unused var warning
    (void) function__;
    try {
  ...
  write_array_impl(RNG& base_rng__, VecR& params_r__, VecI& params_i__,
    ...
    static constexpr const char* function__ =
      "model_Uncorrelated_basic_namespace::write_array";
    // suppress unused var warning
    (void) function__;
    try {
  ...
  inline std::string get_constrained_sizedtypes() const {
    return std::string("[{\"name\":\"delta\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(n_i) + "},\"block\":\"parameters\"},{\"name\":\"sigma_delta\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"eps\",\"type\":{\"name\":\"matrix\",\"rows\":" + std::to_string(n_i) + ",\"cols\":" + std::to_string(n_k) + "},\"block\":\"parameters\"},{\"name\":\"tau_N\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(n_k) + "},\"block\":\"parameters\"},{\"name\":\"rho\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(n_k) + "},\"block\":\"parameters\"},{\"name\":\"mu_rho\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"sigma_rho\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"mu\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(n_k) + "},\"block\":\"transformed_parameters\"},{\"name\":\"tau\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(n_k) + "},\"block\":\"transformed_parameters\"},{\"name\":\"bias\",\"type\":{\"name\":\"matrix\",\"rows\":" + std::to_string(n_i) + ",\"cols\":" + std::to_string(n_k) + "},\"block\":\"transformed_parameters\"},{\"name\":\"prev_mean\",\"type\":{\"name\":\"matrix\",\"rows\":" + std::to_string(n_i) + ",\"cols\":" + std::to_string(n_k) + "},\"block\":\"transformed_parameters\"}]");
  }
...
using stan_model = model_Uncorrelated_basic_namespace::model_Uncorrelated_basic;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_Uncorrelated_basic_namespace::profiles__;
}
#endif
#endif
