...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_Uncorrelated_basic");
    reader.add_event(45, 43, "end", "model_Uncorrelated_basic");
    return reader;
}
#include <stan_meta_header.hpp>
class model_Uncorrelated_basic
  : public stan::model::model_base_crtp<model_Uncorrelated_basic> {
private:
        int n_i;
        int n_k;
        std::vector<std::vector<int> > y;
public:
    model_Uncorrelated_basic(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_Uncorrelated_basic_namespace::model_Uncorrelated_basic";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_Uncorrelated_basic_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_Uncorrelated_basic_namespace::model_Uncorrelated_basic stan_model;
#ifndef USING_R
