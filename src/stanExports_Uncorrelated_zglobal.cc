...
#include "stanExports_Uncorrelated_zglobal.h"

RCPP_MODULE(stan_fit4Uncorrelated_zglobal_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_Uncorrelated_zglobal")
