...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_Correlated_x_zsubpop_zglobal");
    reader.add_event(62, 60, "end", "model_Correlated_x_zsubpop_zglobal");
    return reader;
}
#include <stan_meta_header.hpp>
class model_Correlated_x_zsubpop_zglobal
  : public stan::model::model_base_crtp<model_Correlated_x_zsubpop_zglobal> {
private:
        int n_i;
        int n_k;
        int z_global_size;
...
public:
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_Correlated_x_zsubpop_zglobal_namespace::model_Correlated_x_zsubpop_zglobal";
        ...
        try {
            ...
            validate_non_negative_index("x", "n_k", n_k);
            context__.validate_dims("data initialization", "x", "matrix_d", context__.to_vec(n_i,n_k));
            x = Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic>(n_i, n_k);
            vals_r__ = context__.vals_r("x");
            pos__ = 0;
            size_t x_j_2_max__ = n_k;
            ...
            validate_non_negative_index("alpha", "n_k", n_k);
            num_params_r__ += n_k;
            ...
            validate_non_negative_index("L_Omega", "n_k", n_k);
            validate_non_negative_index("L_Omega", "n_k", n_k);
            num_params_r__ += ((n_k * (n_k - 1)) / 2);
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        pos__ = 0U;
        validate_non_negative_index("alpha", "n_k", n_k);
        context__.validate_dims("parameter initialization", "alpha", "vector_d", context__.to_vec(n_k));
        Eigen::Matrix<double, Eigen::Dynamic, 1> alpha(n_k);
        size_t alpha_j_1_max__ = n_k;
        ...
        validate_non_negative_index("L_Omega", "n_k", n_k);
        validate_non_negative_index("L_Omega", "n_k", n_k);
        context__.validate_dims("parameter initialization", "L_Omega", "matrix_d", context__.to_vec(n_k,n_k));
        Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic> L_Omega(n_k, n_k);
        size_t L_Omega_j_2_max__ = n_k;
        size_t L_Omega_j_1_max__ = n_k;
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            if (jacobian__)
                alpha = in__.vector_constrain(n_k, lp__);
            else
                alpha = in__.vector_constrain(n_k);
            current_statement_begin__ = 18;
            ...
            if (jacobian__)
                L_Omega = in__.cholesky_factor_corr_constrain(n_k, lp__);
            else
                L_Omega = in__.cholesky_factor_corr_constrain(n_k);
            current_statement_begin__ = 22;
            ...
            stan::math::assign(prev_mean,stan::math::exp(add(add(add(transpose(rep_matrix(rho, n_i)), elt_multiply(x, transpose(rep_matrix(alpha, n_i)))), multiply(z_subpop, beta_subpop)), rep_matrix(add(multiply(sigma_delta, delta), multiply(z_global, beta_global)), n_k))));
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_Correlated_x_zsubpop_zglobal_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        ...
        Eigen::Matrix<double, Eigen::Dynamic, 1> alpha = in__.vector_constrain(n_k);
        size_t alpha_j_1_max__ = n_k;
        for (size_t j_1__ = 0; j_1__ < alpha_j_1_max__; ++j_1__) {
        ...
        Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic> L_Omega = in__.cholesky_factor_corr_constrain(n_k);
        size_t L_Omega_j_2_max__ = n_k;
        size_t L_Omega_j_1_max__ = n_k;
        for (size_t j_2__ = 0; j_2__ < L_Omega_j_2_max__; ++j_2__) {
            for (size_t j_1__ = 0; j_1__ < L_Omega_j_1_max__; ++j_1__) {
        ...
        try {
            ...
            validate_non_negative_index("Corr", "n_k", n_k);
            validate_non_negative_index("Corr", "n_k", n_k);
            Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic> Corr(n_k, n_k);
            stan::math::initialize(Corr, DUMMY_VAR__);
            stan::math::fill(Corr, DUMMY_VAR__);
            // generated quantities statements
            current_statement_begin__ = 58;
            stan::math::assign(Corr, multiply(L_Omega, transpose(L_Omega)));
            // validate, write generated quantities
            current_statement_begin__ = 57;
            size_t Corr_j_2_max__ = n_k;
            size_t Corr_j_1_max__ = n_k;
            for (size_t j_2__ = 0; j_2__ < Corr_j_2_max__; ++j_2__) {
                for (size_t j_1__ = 0; j_1__ < Corr_j_1_max__; ++j_1__) {
                    vars__.push_back(Corr(j_1__, j_2__));
                }
            }
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
    ...
    void constrained_param_names(std::vector<std::string>& param_names__,
        ...
        for (size_t j_2__ = 0; j_2__ < Corr_j_2_max__; ++j_2__) {
            for (size_t j_1__ = 0; j_1__ < Corr_j_1_max__; ++j_1__) {
                param_name_stream__.str(std::string());
                param_name_stream__ << "Corr" << '.' << j_1__ + 1 << '.' << j_2__ + 1;
                param_names__.push_back(param_name_stream__.str());
            }
        }
    }
    void unconstrained_param_names(std::vector<std::string>& param_names__,
        ...
        size_t L_Omega_j_1_max__ = ((n_k * (n_k - 1)) / 2);
        for (size_t j_1__ = 0; j_1__ < L_Omega_j_1_max__; ++j_1__) {
            param_name_stream__.str(std::string());
...
typedef model_Correlated_x_zsubpop_zglobal_namespace::model_Correlated_x_zsubpop_zglobal stan_model;
#ifndef USING_R
