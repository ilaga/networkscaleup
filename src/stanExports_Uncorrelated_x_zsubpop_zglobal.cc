...
#include "stanExports_Uncorrelated_x_zsubpop_zglobal.h"

RCPP_MODULE(stan_fit4Uncorrelated_x_zsubpop_zglobal_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_Uncorrelated_x_zsubpop_zglobal")
