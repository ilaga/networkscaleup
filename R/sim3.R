#############################################################
## Simulation 3:
## Model: Negative Binomial likelihood, 6 covariates, 1 local, 2 global, degree correlation
...
local_cov_plot # Suggests x1
global_cov_plot # Suggests x1, x5, x6
...
pois_fit_corr_list = fit_stan_optim(
  sim_dat$ard,
  x_cov_global = as.matrix(sim_dat$x_cov[, c(5,6)]),
  x_cov_local = as.matrix(sim_dat$x_cov[, c(1)]),
  family = "poisson",
  init = 0
)
...
ggsave("./Figures/sim3_local_cov.pdf", local_cov_plot, units = c("in"), width = 12, height = 10)
ggsave("./Figures/sim3_global_cov.pdf", global_cov_plot, units = c("in"), width = 12, height = 10)
ggsave("./Figures/sim3_group_corr_hist.pdf", group_corr_hist, units = c("in"), width = 12, height = 10)
ggsave("./Figures/sim3_group_corr_scree.pdf", group_corr_scree, units = c("in"), width = 12, height = 10)
ggsave("./Figures/sim3_degree_corr_hist.pdf", degree_corr_hist, units = c("in"), width = 12, height = 10)
ggsave("./Figures/sim3_degree_corr_scree.pdf", degree_corr_scree, units = c("in"), width = 12, height = 10)
